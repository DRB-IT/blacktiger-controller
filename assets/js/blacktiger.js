    ...
    .provider('$blacktiger', function () {
        ...
        return {
            ...
            kickParticipant: function (userid) {
                return $http({
                    method: 'POST',
                    url: $blacktiger.getServiceUrl() + "rooms/" + $room.getCurrent() + "/" + userid + "/kick"
                }).then(function (response) {
                    return;
                });
            },
            muteParticipant: function (userid) {
                return $http({
                    method: 'POST',
                    url: $blacktiger.getServiceUrl() + "rooms/" + $room.getCurrent() + "/" + userid + "/mute"
                }).then(function () {
                    return;
                });
            },
            unmuteParticipant: function (userid) {
                return $http({
                    method: 'POST',
                    url: $blacktiger.getServiceUrl() + "rooms/" + $room.getCurrent() + "/" + userid + "/unmute"
                }).then(function () {
                    return;
                });
            },
